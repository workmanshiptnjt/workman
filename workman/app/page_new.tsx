...
import { Brain, Users, BookMarked, Zap, Heart, Flame, Download, Star, TrendingUp, MessageCircle } from 'lucide-react';
import { FadeInUp, SlideInLeft, SlideInRight, FloatingAnimation } from '@/components/AnimatedSection';
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <motion.div
          className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-purple-600/20 to-transparent rounded-full blur-3xl"
          animate={{ x: [0, 50, 0], y: [0, 30, 0] }}
          transition={{ duration: 20, repeat: Infinity }}
        />
        <motion.div
          className="absolute top-1/2 -left-40 w-96 h-96 bg-gradient-to-br from-blue-600/20 to-transparent rounded-full blur-3xl"
          animate={{ x: [0, -50, 0], y: [0, -30, 0] }}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <SlideInLeft>
              <div className="space-y-8">
                ...
                >
                  <motion.button
                    className="group relative px-8 py-4 bg-gradient-to-r from-purple-600 to-purple-500 text-white rounded-xl font-semibold overflow-hidden"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-500 opacity-0 group-hover:opacity-100 transition-opacity"
                      initial={{ x: '-100%' }}
                      whileHover={{ x: 0 }}
                  ...
                  <motion.button
                    className="px-8 py-4 border-2 border-purple-500/50 text-white rounded-xl font-semibold hover:border-purple-400 hover:bg-purple-900/20 transition-all"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Learn More
              ...
              <FloatingAnimation>
                ...
                >
                  <div className="relative w-full h-full flex items-center justify-center">
                    ...
                    <motion.div
                      className="w-64 h-96 rounded-3xl bg-gradient-to-br from-purple-500/20 to-purple-900/20 border-2 border-purple-500/50 shadow-2xl flex items-center justify-center overflow-hidden"
                      whileHover={{ scale: 1.05 }}
                    >
                    ...
                    {/* Floating elements */}
                    <motion.div
                      className="absolute top-10 right-0 p-3 bg-blue-500/20 rounded-lg border border-blue-500/50"
                      animate={{ y: [0, -30, 0] }}
                    ...
                    <motion.div
                      className="absolute bottom-20 left-0 p-3 bg-pink-500/20 rounded-lg border border-pink-500/50"
                      animate={{ y: [0, 30, 0] }}
          ...
          >
            {testimonials.map((testimonial, idx) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="p-8 rounded-2xl bg-gradient-to-br from-gray-900/50 to-black border border-purple-900/20 hover:border-purple-500/50 transition-all"
              >
      ...
      <section className="relative py-20">
        <div className="container">
          <motion.div
            className="relative overflow-hidden rounded-3xl p-12 lg:p-20 bg-gradient-to-br from-purple-900/30 to-black border border-purple-500/20"
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <motion.button
                className="group relative px-10 py-4 bg-gradient-to-r from-purple-600 to-purple-500 text-white rounded-xl font-semibold overflow-hidden inline-block"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <motion.div
